...
import '../../widget/utils/consumable_store.dart';
...
@RoutePage<String>()
class BullingWidgetScreen extends StatefulWidget {
  @override
  State<BullingWidgetScreen> createState() => _BullingWidgetScreenState();
}

class _BullingWidgetScreenState extends State<BullingWidgetScreen> {
