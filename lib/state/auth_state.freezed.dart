...
mixin _$AuthState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(User user) ready,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(User user)? ready,
...
class _$_AuthStateReady implements _AuthStateReady {
  const _$_AuthStateReady(this.user);
  ...
  @override
  String toString() {
    return 'AuthState.ready(user: $user)';
  }
...
abstract class _AuthStateReady implements AuthState {
  const factory _AuthStateReady(final User user) = _$_AuthStateReady;
